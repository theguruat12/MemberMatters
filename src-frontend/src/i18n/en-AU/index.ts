...
export default {
  ...
  access: {
    ...
    roleTrainer: 'Trainer',
    roleUser: 'Authorised',
    trainerPanel: 'Interlocks I Manage',
    trainerPanelDesc:
      'As a trainer you can grant and revoke member access for the interlocks below.',
    noMembersWithAccess: 'No members have been granted access yet.',
    searchMembers: 'Search members',
    grantAccess: 'Grant Access',
    revokeAccess: 'Revoke Access',
    assignTrainer: 'Assign Trainer',
    revokeTrainer: 'Revoke Trainer',
    rolesTab: 'Roles',
    door: 'Door | Doors',
